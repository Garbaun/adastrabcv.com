...
export default function Page() {
  return (
    <div className="w-full">
      <section className="w-full max-w-[1920px] mx-auto h-[420px] md:h-[600px] flex items-center justify-center bg-gradient-to-br from-night via-pink to-lila dark:from-night dark:via-violet/30 dark:to-night relative overflow-hidden">
        ...
        <div className="relative text-center px-5">
          ...
          <h1 className="mt-3 text-4xl md:text-6xl font-extrabold tracking-tight text-white">Projeler</h1>
          <p className="mt-3 text-sm md:text-base font-semibold text-white/80">Başarı hikâyelerimiz — hero görseli için ayrılan renkli alan</p>
